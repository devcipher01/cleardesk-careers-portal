...
export const getWorkspaceBySession = createServerFn({ method: "GET" })
  .handler(async () => {
    const cookieHeader = getRequestHeader("cookie");
    const applicationId = getApplicationIdFromCookies(cookieHeader);
...
export const getTaskProgressBySession = createServerFn({ method: "GET" })
  .handler(async () => {
    const cookieHeader = getRequestHeader("cookie");
    const applicationId = getApplicationIdFromCookies(cookieHeader);
...
export const getPaymentInfoBySession = createServerFn({ method: "GET" })
  .handler(async () => {
    const cookieHeader = getRequestHeader("cookie");
    const applicationId = getApplicationIdFromCookies(cookieHeader);
...
export const onboardingGetBySession = createServerFn({ method: "GET" })
  .handler(async () => {
    const cookieHeader = getRequestHeader("cookie");
    const applicationId = getApplicationIdFromCookies(cookieHeader);
...
export const onboardingCompleteBySession = createServerFn({ method: "POST" })
  .inputValidator(z.object({ ready: z.boolean() }))
  .handler(async ({ data }) => {
    const cookieHeader = getRequestHeader("cookie");
    const applicationId = getApplicationIdFromCookies(cookieHeader);
    if (!applicationId) throw new Error("Not authenticated");
...
export const sendSupportMessageBySession = createServerFn({ method: "POST" })
  .inputValidator(z.object({ message: z.string().min(5).max(2000) }))
  .handler(async ({ data }) => {
    const cookieHeader = getRequestHeader("cookie");
    const applicationId = getApplicationIdFromCookies(cookieHeader);
    if (!applicationId) throw new Error("Not authenticated");
